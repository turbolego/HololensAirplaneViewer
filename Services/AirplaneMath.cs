...
namespace HololensAirplaneViewer.Services
{
    ...
    public static class AirplaneMath
    {
        ...
        /// <summary>
        /// Minimum length of an OpenSky Network state vector array.
        /// The API returns 17 fields per state (indices 0–16):
        /// [0]=icao24, [1]=callsign, [2]=origin_country, [3]=time_position,
        /// [4]=last_contact, [5]=longitude, [6]=latitude, [7]=baro_altitude,
        /// [8]=on_ground, [9]=velocity, [10]=true_track, [11]=vertical_rate,
        /// [12]=sensors, [13]=geo_altitude, [14]=squawk, [15]=spi, [16]=position_source.
        /// A guard of &lt; 18 (or any value above 17) would reject EVERY aircraft.
        /// </summary>
        public const int OpenSkyStateVectorMinimumFields = 17;
