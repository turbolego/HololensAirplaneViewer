...
.SYNOPSIS
    ...
    HololensAirplaneViewer_TemporaryKey.pfx.
...
.EXAMPLE
    # From the repo root (HololensAirplaneViewer\):
    powershell -ExecutionPolicy Bypass -File scripts\create_cert.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "HololensAirplaneViewer_TemporaryKey.pfx",
...
$cert = New-SelfSignedCertificate `
    -Type Custom `
    -Subject "CN=HololensAirplaneViewer" `
    -KeyUsage DigitalSignature `
    -FriendlyName "HololensAirplaneViewer" `
