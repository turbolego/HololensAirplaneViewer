...
The master image (`scripts/icon_master.png`) is the single source of truth
...
MASTER_PATH = os.path.join(SCRIPT_DIR, "icon_master.png")
...
def main():
    if not os.path.exists(MASTER_PATH):
        raise FileNotFoundError(
            ...
            "Place the app icon artwork at scripts/icon_master.png and re-run."
        )
